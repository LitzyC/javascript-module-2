...
let destinationNamesWithin500Kms = travelDestinations.filter((milas)=> milas.distanceKms <= 500 ).map((milas) => milas.destinationName);// Complete here

let destinationNameReachableByFerry = travelDestinations.find((transp) => transp.transportations.some((trans)=> trans == "ferry")).destinationName;// Complete here
